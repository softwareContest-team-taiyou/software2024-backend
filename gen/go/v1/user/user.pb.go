...
type GetUserResponse struct {
	...
	IsInit string `protobuf:"bytes,2,opt,name=is_init,json=isInit,proto3" json:"is_init,omitempty"`
}
...
func (x *GetUserResponse) GetIsInit() string {
	if x != nil {
		return x.IsInit
	}
	return ""
...
func (x *UpdateUserRequest) GetIsInit() string {
	if x != nil {
		return x.IsInit
	}
	return ""
...
var file_v1_user_user_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x5f, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x69,
	...
	0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x69, 0x73, 0x49, 0x6e, 0x69,
	0x74, 0x22, 0x43, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
