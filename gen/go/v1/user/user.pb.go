...
var file_v1_user_user_proto_rawDesc = []byte{
	...
	0x07, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x01, 0x32, 0xaa, 0x01, 0x0a, 0x0b, 0x55,
...
var file_v1_user_user_proto_depIdxs = []int32{
	...
	3, // 1: proto.user.v1.UserService.CreateUser:input_type -> proto.user.v1.CreateUserRequest
	1, // 2: proto.user.v1.UserService.GetUser:input_type -> proto.user.v1.GetUserRequest
	4, // 3: proto.user.v1.UserService.CreateUser:output_type -> proto.user.v1.CreateUserResponse
	2, // 4: proto.user.v1.UserService.GetUser:output_type -> proto.user.v1.GetUserResponse
